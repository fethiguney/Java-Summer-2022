...
public class C03_ClassVariables {
    public static void main(String[] args) {
        ...
        /*Yazdirmak istediğimizde java Class içinde bulunan method'a
        gider ve method içindeki degeri ne ise onu getirir, class içinde
	yapılan değisikliklere bakmaz

         */

            System.out.println(C02_StaticVariables.staticSayi); //10
        /*Yazdirmak istediğimizde java class içinde variable'ın karsisinda
        yazan degere bakar ve ne ise onu getirir, o variable class içinde
	daha sonra degistirilmis ise bunu dikkate almaz
