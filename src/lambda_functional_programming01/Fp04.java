...
public class Fp04 {
    public static void main(String[] args) {
        ...
        System.out.println(ikiSayiArasindakiCiftSayilarinToplami(10,2));
        System.out.println(ikiSayiArasindakiTumSayilarinRakamlarToplaminiBul(11,10));
    ...
    //2) 2'den 11'e kadar integer değerlerinin
    // çarpımını bulan bir method oluşturun.
...
// toplamını bulan bir method oluşturun.
    ...
    public static int ikiSayiArasindakiTumSayilarinRakamlarToplaminiBul(int x, int y) {
        int z=0;
        if (x>y) {
            z=x;
            x=y;
