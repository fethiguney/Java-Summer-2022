...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(kelimeKursAdlariIcerisindeVarMi(coursesList, "Turkish"));
        ortalamasiEnYuksekOlanKursunAdiniYazdir(coursesList);
    ...
    //2)Kurs adlarından en az birinin verilen kelimeyi
    // içerip içermediğini kontrol etmek için bir method oluşturun

    public static boolean kelimeKursAdlariIcerisindeVarMi(List<Courses> list, String str) {
    ...
    public static void ortalamasiEnYuksekOlanKursunAdiniYazdir(List<Courses> list) {
    ...
    //4) List öğelerini artan düzende ortalama
    // puana göre sıralayın ve ilk verilenleri atlayın

    public static List<Courses> ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(List<Courses> liste, int x) {
       return liste.stream().sorted(Comparator.comparing(Courses::getAverageScore)).skip(x).collect(Collectors.toList());
    }
